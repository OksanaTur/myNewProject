...
import backgroungImg from '../../../assets/images/Photo BG-2.jpg';
    ...
    return (
        <TouchableWithoutFeedback onPress={handleKeyboardHide}>
            <View style={container}>
                <ImageBackground source={backgroungImg} style={bgContainer}>
                    <View style={contentWrapper}>
                        <KeyboardAvoidingView
                            ...
                            <TextInput
                                style={{ ...input }}
                                placeholder='дреса електронної пошти'
                                onFocus={handleFocus} />
                        ...
                        {!isShowKeyboard && (
                            <View>
                                ...
                                <TouchableOpacity style={link}>
                                    <Text style={linkText}> Немає акаунту?
